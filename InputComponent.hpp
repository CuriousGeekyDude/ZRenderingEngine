...
namespace Library
{
	...
	public:
		...
		explicit InputComponent(Engine& game,MouseModes mode = MouseModes::Relative);
	...
	public:
		...
		const DirectX::Keyboard::State& CurrentStateKeyboard() const;
	...
	private:
		...
		DirectX::Keyboard::State m_currentStateKeyboard{};
		DirectX::Keyboard::State m_lastStateKeyboard{};
